...
class GameWindow:
    def __init__(self):
        ...
        self.thinking = False
        self.engine_time = 2  # Engine thinking time in seconds
    ...
    def handle_mouse_down(self):
        ...
        if 0 <= col < 8 and 0 <= row < 8:
            ...
            if self.position.board[square].isupper():  # White pieces (upper case)
    ...
    def engine_move(self):
        ...
        try:
            ...
            if best_move:
                ...
                # Make sure we don't try to capture a white piece
    ...
    def update_screen(self):
        ...
        if self.selected_square is not None:
            ...
            highlight.fill((255, 255, 0, 100))  # Semi-transparent yellow
